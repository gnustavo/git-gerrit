...
instructions, please, read the manpage of the L<git-gerrit(1)> script.
...
=item * show votes with --verbose

This should work on 'git gerrit show' and 'git gerrit query'.

=item * better format the output of 'git gerrit query'

I'm thinking about using Text::Table to do it.
