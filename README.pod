...
The git-gerrit script is a Git extension to implement a Gerrit
workflow.
...
Then, you should install the App::GitGerrit distribution from
L<CPAN|http://search.cpan.org/dist/App-GitGerrit/>. You can do it
